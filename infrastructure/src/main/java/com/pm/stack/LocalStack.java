...
public class LocalStack extends Stack {
    ...
    public LocalStack(final App scope, final String id, final StackProps props) {
        ...
        FargateService authService = createFargateService(
                ...
                List.of(4005),
                authServiceDB,
                Map.of("JWT_SECRET", "superdupersecretchangemeinproduction")
        );
        ...
        ContainerDefinitionOptions.Builder containerOptions = ContainerDefinitionOptions.builder()
                ...
                .portMappings(ports.stream()
                        .map(port -> PortMapping.builder()
                                .containerPort(port) // Running on port in the container
                                .hostPort(port) // Expose this port to other services
